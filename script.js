...
ScrollReveal().reveal('.home-img, .services-container, .portfolio-box, .blog-content,.section-title,.contact form', {origin: 'bottom'});
ScrollReveal().reveal('.home-content h1, .about-img ,.card:nth-child(odd) ,.contact-left ,.blog-subtitle', {origin: 'left'});
